...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('comma-separated-values')) :
	typeof define === 'function' && define.amd ? define(['comma-separated-values'], factory) :
	(factory(global.CSV));
}(this, (function (CSV) { 'use strict';

	CSV = CSV && CSV.hasOwnProperty('default') ? CSV['default'] : CSV;
	...
	const getScenario = async name => {
	  ...
	  const data = await fetchWithHash(`/blhxfy/data/scenario/${pathname}`);
